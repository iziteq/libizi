...
class FullPublisher extends PublisherBase implements FullPublisherInterface
{
   ...
   */
  public function __construct($uuid, $revisionHash, array $availableLanguageCodes, ContentProviderInterface $contentProvider, $status, array $content, array $contactInformation) {
  ...
  public static function createFromData($data) {
    ...
    return new static($data['uuid'], $data['hash'], $data['languages'], $contentProvider, $data['status'], $content, $contactInformation);
  }
