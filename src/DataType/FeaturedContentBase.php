...
abstract class FeaturedContentBase implements FeaturedContentInterface
{
   ...
   */
  public function __construct($uuid, $status, $promoted, $requestedLanguageCode, $languageCode, $name, $description, $position, array $images)
  {
    $this->uuid = $uuid;
    $this->status = $status;
  ...
  public static function createFromData($data) {
    ...
    return new static($data['uuid'], $data['status'], $data['promoted'], $data['language'], $data['content_language'], $data['name'], $data['description'], $data['position'], $images);
  }
