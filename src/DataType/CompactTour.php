...
class CompactTour extends CompactMtgObjectBase implements CompactTourInterface
{
  ...
  public function __construct(
    ...
    parent::__construct($uuid, $revisionHash, $availableLanguageCodes,
      ...
      $languageCode, $title, $summary, $images, $numberOfChildren, $category, $duration, $distance, $placement);
    $this->route = $route;
  }
  ...
  public static function createFromData($data)
  {
    ...
    return new static($data['uuid'], $data['hash'], $data['languages'],
      ...
      $data['summary'], $images, $data['children_count'], $data['category'], $data['duration'], $data['distance'], $data['placement'], $data['route']);
  }
