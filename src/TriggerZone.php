...
class TriggerZone implements TriggerZoneInterface {
  ...
  public static function createFromJson($json) {
    ...
    elseif ($data['type'] == static::TYPE_POLYGONAL) {
      ...
      throw new InvalidTriggerZoneTypeFactoryException(sprintf('Invalid trigger zone type %s. Must be one of %s.', $data['type'], implode(', ', [static::TYPE_POLYGONAL, static::TYPE_CIRCULAR])));
    }
  }
