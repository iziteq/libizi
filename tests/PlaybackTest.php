...
/**
 * @file
 * Contains \Triquanta\IziTravel\Tests\PlaybackTest.
 */

namespace Triquanta\IziTravel\Tests;

use Triquanta\IziTravel\Playback;

/**
 * @coversDefaultClass \Triquanta\IziTravel\Playback
 */
class PlaybackTest extends \PHPUnit_Framework_TestCase {
   ...
   *
   * @var \Triquanta\IziTravel\Playback
   */
  protected $sut;
...
JSON;
  ...
  public function testIsRandom() {
    ...
    $playback_sequantial = new Playback(Playback::TYPE_SEQUENTIAL, $this->uuids);
