...
/**
 * @file
 * Contains \Triquanta\IziTravel\Tests\DataType\ConsumerTest.
 */

namespace Triquanta\IziTravel\Tests\DataType;

use Triquanta\IziTravel\DataType\Consumer;

/**
 * @coversDefaultClass \Triquanta\IziTravel\DataType\Consumer
 */
class ConsumerTest extends \PHPUnit_Framework_TestCase
{
     ...
     *
     * @var \Triquanta\IziTravel\DataType\Consumer
     */
    protected $sut;
    ...
    public function setUp()
    {
        ...
        $this->sut = new Consumer($this->uuid, $this->username,
          $this->emailAddress, $this->mobilePhoneNumber, $this->customStorage);
    }
...
JSON;
    ...
    {
        $this->assertSame($this->mobilePhoneNumber,
          $this->sut->getMobilePhoneNumber());
    }
