...
JSON;
    ...
    $this->assertInstanceOf('\Triquanta\IziTravel\CircularTriggerZoneInterface', TriggerZone::createFromJson($json));
  }
...
JSON;
    ...
    $this->assertInstanceOf('\Triquanta\IziTravel\PolygonalTriggerZoneInterface', TriggerZone::createFromJson($json));
  }
