...
class ScheduleTest extends \PHPUnit_Framework_TestCase {
   ...
   *
   * @var \Triquanta\IziTravel\Schedule
   */
  protected $sut;
  ...
  public function testGetMondaySchedule() {
    $this->assertSame($this->schedule['mon'], $this->sut->getMondaySchedule());
  }
  ...
  public function testGetTuesdaySchedule() {
    $this->assertSame($this->schedule['tue'], $this->sut->getTuesdaySchedule());
  }
  ...
  public function testGetWednesdaySchedule() {
    $this->assertSame($this->schedule['wed'], $this->sut->getWednesdaySchedule());
  }
  ...
  public function testGetThursdaySchedule() {
    $this->assertSame($this->schedule['thu'], $this->sut->getThursdaySchedule());
  }
  ...
  public function testGetFridaySchedule() {
    $this->assertSame($this->schedule['fri'], $this->sut->getFridaySchedule());
  }
  ...
  public function testGetSaturdaySchedule() {
    $this->assertSame($this->schedule['sat'], $this->sut->getSaturdaySchedule());
  }
  ...
  public function testGetSundaySchedule() {
    $this->assertSame($this->schedule['sun'], $this->sut->getSundaySchedule());
  }
