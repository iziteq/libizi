...
/**
 * @file
 * Contains \Triquanta\IziTravel\Tests\CompactMtgObjectTest.
 */

namespace Triquanta\IziTravel\Tests;

use Triquanta\IziTravel\CompactMtgObject;
use Triquanta\IziTravel\MtgObjectInterface;

/**
 * @coversDefaultClass \Triquanta\IziTravel\CompactMtgObject
 */
class CompactMtgObjectTest extends \PHPUnit_Framework_TestCase {
   ...
   *
   * @var \Triquanta\IziTravel\CompactMtgObject
   */
  protected $sut;
  ...
  public function setUp() {
    ...
    $this->sut = new CompactMtgObject($this->uuid, $this->availableLanguageCodes, $this->category, $this->status, $this->location, $this->triggerZones, $this->contentProvider, $this->purchase, $this->duration, $this->distance, $this->placement, $this->visibleOnMaps, $this->languageCode, $this->route, $this->title, $this->summary, $this->images, $this->numberOfChildren);
  }
