...
/**
 * @file
 * Contains \Triquanta\IziTravel\Tests\PurchaseTest.
 */

namespace Triquanta\IziTravel\Tests;

use Triquanta\IziTravel\Purchase;

/**
 * @coversDefaultClass \Triquanta\IziTravel\Purchase
 */
class PurchaseTest extends \PHPUnit_Framework_TestCase {
   ...
   *
   * @var \Triquanta\IziTravel\Purchase
   */
  protected $sut;
  ...
  public function setUp() {
    ...
    $this->sut = new Purchase($this->currencyCode, $this->price, $this->productId);
  }
